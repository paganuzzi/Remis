...
<div class="col-md-offset-3">
                	<ol class="breadcrumb">
                        ...
                        <li><a href="/user/{{Auth::user()->id}}/edit">{{Auth::user()->nombreapellido}}</a></li>
					...
					{{Form::open(array('url' => '/user/'.$data->id,'role'=>'form','method'=>'put'))}}


				    <div class="form-group">
				        {{Form::label('nombreapellido', 'Nombre y apellido', array('class' => 'control-label'))}}
				        {{Form::text('nombreapellido',$data->nombreapellido, array('class' => 'form-control', 'placeholder' => 'Nombre y apellido','autofocus'=>'autofocus'))}}
				    </div>
				    ...
				    <div class="form-group">
				        ...
				        {{Form::text('username',$data->username, array('class' => 'form-control', 'placeholder' => 'Nombre de usuario'))}}
				    </div>
				    ...
				    <div class="form-group">
				        ...
				        {{Form::text('email',$data->email, array('class' => 'form-control', 'placeholder' => 'Correo electronico'))}}
				    </div>
            ...
            <div class="form-group">
                ...
                {{Form::select('usertype',['Administrador','Usuario'],$data->usertype,array('class' => 'form-control'))}}
            </div>

				    <div class="form-group">
				        {{Form::label('active', '¿El usuario esta habilitado?', array('class' => 'control-label'))}}
				        {{Form::checkbox('active',$data->active,$data->active, array('placeholder' => '¿El usario esta habilitado?'))}}
				    </div>
